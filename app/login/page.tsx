    ...
    <div style={{ minHeight: "100vh", background: "#F8FAFC", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px 16px" }}>
      <div style={{ width: "100%", maxWidth: 448 }}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <h1 style={{ fontSize: "1.5rem", fontWeight: 700, color: "#0F172A", margin: 0 }}>Welcome back</h1>
          <p style={{ color: "#64748B", marginTop: 4, fontSize: "0.875rem" }}>Log in to your ListifyPH account</p>
        </div>
          ...
          <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
                <label style={{ fontSize: "0.875rem", fontWeight: 500, color: "#0F172A" }}>Password</label>
                <Link href="/forgot-password" style={{ fontSize: 12, color: "#3B82F6", textDecoration: "none" }}>Forgot password?</Link>
              </div>
        ...
        <p style={{ textAlign: "center", fontSize: "0.875rem", color: "#64748B", marginTop: 24 }}>
          ...
          <Link href="/signup" style={{ color: "#3B82F6", fontWeight: 500, textDecoration: "none" }}>Sign up free</Link>
        </p>
      </div>
    </div>
  );
